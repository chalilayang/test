...
import se.emilsjolander.stickylistheaders.sample.TestBaseAdapter;

/**
 * @author Emil Sjölander
 */
public class StickyListTestActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sticky_list_extra);
        ...
        stickyList.addHeaderView(getLayoutInflater().inflate(R.layout.list_header_extra, null));
        stickyList.addFooterView(getLayoutInflater().inflate(R.layout.list_footer_extra, null));
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.open_expandable_list_button:
                    Intent intent = new Intent(StickyListTestActivity.this,ExpandableListTestActivity.class);
